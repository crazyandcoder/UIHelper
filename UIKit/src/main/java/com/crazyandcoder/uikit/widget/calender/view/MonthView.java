...
import com.crazyandcoder.uikit.widget.calender.utils.Lunar;
import com.crazyandcoder.uikit.widget.calender.utils.LunarSolarConverter;
import com.crazyandcoder.uikit.widget.calender.utils.Solar;
...
public class MonthView extends View {
    ...
    public void setParams(Map<String, Integer> params) {
        ...
        if (firstDay != -1) {
            ...
            //第一次选中日期到当前展示月份的天数差
            curToFirstDayDiff = Utils.getOffsetDay(firstCalendar, currentCalendar);
        }
