...
public class CalendarUtils {
    ...
    public static CalendarData getCalendarData(String defaultDate) {
        ...
        try {
            ...
            dateBean.setFormatDate(new SimpleDateFormat("yyyy-MM-dd").format(calendar.getTime()));
     ...
     */
    public static List<CalendarData> getCalendarData(String sDate, String eDate) {
        ...
        try {
            ...
            for (; calendar.getTimeInMillis() <= endDate.getTime(); ) {
                ...
                for (; monthCalendar.getTimeInMillis() <= endMonthDay.getTime(); ) {
                    ...
                    dateBean.setFormatDate(format.format(monthCalendar.getTime()));
