package com.crazyandcoder.uikit.widget.date.wheel;
...
import com.crazyandcoder.uikit.widget.date.bean._enum.CurvedArcDirection;
import com.crazyandcoder.uikit.widget.date.bean._enum.DividerType;
import com.crazyandcoder.uikit.widget.date.bean._enum.TextAlign;
import com.crazyandcoder.uikit.widget.date.helper.SoundHelper;
import com.crazyandcoder.uikit.utils.DpSpUtils;

import java.util.ArrayList;
import java.util.List;

import static com.crazyandcoder.uikit.widget.date.bean._enum.ICurvedArcDirection.CURVED_ARC_DIRECTION_CENTER;
import static com.crazyandcoder.uikit.widget.date.bean._enum.ICurvedArcDirection.CURVED_ARC_DIRECTION_LEFT;
import static com.crazyandcoder.uikit.widget.date.bean._enum.ICurvedArcDirection.CURVED_ARC_DIRECTION_RIGHT;
import static com.crazyandcoder.uikit.widget.date.bean._enum.IDividerType.DIVIDER_TYPE_FILL;
import static com.crazyandcoder.uikit.widget.date.bean._enum.ITextAlign.TEXT_ALIGN_CENTER;
import static com.crazyandcoder.uikit.widget.date.bean._enum.ITextAlign.TEXT_ALIGN_LEFT;
import static com.crazyandcoder.uikit.widget.date.bean._enum.ITextAlign.TEXT_ALIGN_RIGHT;

public class WheelView<T> extends View implements Runnable {

    private static final String TAG = "WheelView";

    private static final float DEFAULT_LINE_SPACING = DpSpUtils.dp2px(2f);
    private static final float DEFAULT_TEXT_SIZE = DpSpUtils.sp2px(15f);
    private static final float DEFAULT_TEXT_BOUNDARY_MARGIN = DpSpUtils.dp2px(2);
    private static final float DEFAULT_DIVIDER_HEIGHT = DpSpUtils.dp2px(1);
    ...
    public void setTextSize(float textSize, boolean isSp) {
        ...
        mTextSize = isSp ? DpSpUtils.sp2px(textSize) : textSize;
    ...
    public void setTextBoundaryMargin(float textBoundaryMargin, boolean isDp) {
        ...
        mTextBoundaryMargin = isDp ? DpSpUtils.dp2px(textBoundaryMargin) : textBoundaryMargin;
    ...
    public void setLineSpacing(float lineSpacing, boolean isDp) {
        ...
        mLineSpacing = isDp ? DpSpUtils.dp2px(lineSpacing) : lineSpacing;
    ...
    public void setDividerHeight(float dividerHeight, boolean isDp) {
        ...
        mDividerSize = isDp ? DpSpUtils.dp2px(dividerHeight) : dividerHeight;
    ...
    public void setDividerPaddingForWrap(float dividerPaddingForWrap, boolean isDp) {
        ...
        mDividerPaddingForWrap = isDp ? DpSpUtils.dp2px(dividerPaddingForWrap) : dividerPaddingForWrap;
